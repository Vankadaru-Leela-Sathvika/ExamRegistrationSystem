...
public class UserCheck
{
	...
	{
	try{
	String url = "jdbc:mysql://localhost:3308/examregsystem";
	String _user = "root";
	String _password = "pass1234";
	Class.forName("com.mysql.cj.jdbc.Driver");
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3308/examregsystem?autoReconnect=true&useSSL=false",_user,_password);
