...
public class Register extends HttpServlet //throws IOException,ServletException,Exception
{
	public void doPost(HttpServletRequest request, HttpServletResponse response) //throws IOException //,Exception
	{
		...
		else
		{
			...
			out.println("<h2>Enter Details</h2><section class=reg><form action=createuser method=post><label for=name>Name:</label><br>");
